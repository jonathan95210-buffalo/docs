...
You can follow along with a [video tutorial](https://wandb.me/pytorch-video).

**Note**: Sections starting with **Step** are all you need to integrate W&B in an existing pipeline. The remaining sections load data and define a model.
